...
<input type="hidden" id="current_user" value="<?php echo e($user_id); ?>">
...
Hello <?php echo e($username->name); ?>
...
var curr_user_id = <?php echo e($user_id); ?>;
  $(function () {
	    $.ajaxSetup({
          headers: {
	 ...
	 $('#userTasksTable').on('click', '.deleteTask', function(){
        ...
        $.ajax({
				  ...
				  url: "<?php echo e(route('usertasks.store')); ?>",
				  type: "POST",
				  dataType: 'json',
...
</html><?php /**PATH C:\wamp64\www\crud\resources\views/userTasks.blade.php ENDPATH**/ ?>